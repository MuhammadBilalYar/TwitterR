...
namespace TwittR.Api.Tests.IntegrationTests.NotificationType
{
    ...
    public class DeleteNotificationTypeIntegrationTests : IClassFixture<CustomWebApplicationFactory>
    { 
        private readonly CustomWebApplicationFactory _factory;

        public DeleteNotificationTypeIntegrationTests(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        }
        ...
        [Fact]
        public async Task DeleteNotificationType204AndFieldsWereSuccessfullyUpdated()
        {
            ...
            var deleteRequest = new HttpRequestMessage(method, $"api/NotificationTypes/{id}");
